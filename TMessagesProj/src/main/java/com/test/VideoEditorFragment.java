...
@TargetApi(16)
public class VideoEditorFragment extends Fragment implements TextureView.SurfaceTextureListener {
    ...
    public VideoEditorFragment(Bundle args) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        compressVideo.setText(getString(R.string.CompressVideo));
        ...
        titleTextView.setText(getString(R.string.OriginalVideo));
        titleTextView = (TextView) fragmentView.findViewById(R.id.edited_title);
        titleTextView.setText(getString(R.string.EditedVideo));
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        menu.clear();
        inflater.inflate(R.menu.menu_video_editor, menu);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.video_editor:
                ...
                ((AppCompatActivity)getActivity()).getSupportFragmentManager().beginTransaction().addToBackStack("video").commit();
                if (delegate != null) {
    ...
    private void fixVideoSize() {
        if (fragmentView == null || getActivity() == null) {
            return;
        }
        int viewHeight;
